...
public class RequestHelperUnitTest {
    ...
    @Test
    public void testHashParamsWithSecurityToken() {
    ...
    @Test
    public void testHashResponseWithSecurityToken() {
        // The expected hash is obtained from http://www.sha1-online.com
        String expected = "ebf25d001c029edf0087df0e2b26215d44246c25";
        String stringToHash = "foo";
        String securityToken = "1c915e3b5d42d05136185030892fbb846c278927";
        String actual = RequestHelper.hashResponseWithSecurityToken(stringToHash, securityToken);
        Assert.assertEquals(expected, actual);
    }
    ...
    public void testIsResponseCorrupted() {
        ...
        String validSignature =
                RequestHelper.hashResponseWithSecurityToken("foo", securityToken);
